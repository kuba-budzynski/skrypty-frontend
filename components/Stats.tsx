        ...
        <div className="relative h-32">
            ...
            <div className="relative pt-2 max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8" >
                <div className="max-w-4xl mx-auto">
                    <dl className="rounded-lg bg-white shadow-2xl grid grid-cols-3">
                        <div className="flex flex-col  border-gray-400 p-4 sm:p-6 text-center border-0 border-r">
                        ...
                        <div className="flex flex-col border-gray-400 p-4 sm:p-6 text-center border-0 border-l border-r">
                        ...
                        <div className="flex flex-col border-gray-400 p-4 sm:p-6 text-center border-0 border-l">
